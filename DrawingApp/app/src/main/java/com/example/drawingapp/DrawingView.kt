...
class DrawingView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        when(event?.action) {
//            This event will be fired when user put his finger on the screen
...
//            This event will be fired when user move his finger on screen
            MotionEvent.ACTION_MOVE -> {
                drawPath.lineTo(touchX!!, touchY!!)
            }
//            This event will be fired when user move his finger up
